...
class BOOST_SYMBOL_VISIBLE xml_oarchive_impl : 
    ...
    public basic_xml_oarchive<xml_oarchive_impl<Archive> >
{
#ifdef BOOST_NO_MEMBER_TEMPLATE_FRIENDS
public:
#else
protected:
    friend class detail::interface_oarchive<xml_oarchive_impl<Archive> >;
    friend class basic_xml_oarchive<xml_oarchive_impl<Archive> >;
